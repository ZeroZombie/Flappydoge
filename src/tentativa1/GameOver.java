...
public abstract class GameOver {
       ...
       public static void drawGameOver(Graphics g, Board board) throws InterruptedException {        
        ...
        String recordJogador = board.getPoints().getRecord()[0].getJogador().toUpperCase();
        String recordPontos2 = Float.toString(board.getPoints().getRecord()[1].getPontos());
        String recordJogador2 = board.getPoints().getRecord()[1].getJogador().toUpperCase();
        String recordPontos3 = Float.toString(board.getPoints().getRecord()[2].getPontos());
        String recordJogador3 = board.getPoints().getRecord()[2].getJogador().toUpperCase();
        ...
        g.setFont(new Font("Copperplate Gothic Light", Font.PLAIN, 23));
